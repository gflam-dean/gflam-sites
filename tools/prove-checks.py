...
MUTATIONS = [
    ...
    ('tv-ads-rebuild.test.js', 'venueplay/tv.html',
     ...
     'var adIdx=0, adTimer=null, adBuilt=false, adFadeTimer=null, adsSigGone=null;',
     'the ad loop forgets what it already built and rebuilds on every tab switch'),
    ...
    ('billing-hosts.test.js', 'venueplay/app/billing.html',
     'class="mgr-p" value="advertising"', 'class="mgr-q" value="advertising"',
     'the manager permission boxes stop being read, so a host is added with the wrong access'),
